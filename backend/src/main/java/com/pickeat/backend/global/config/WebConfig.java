...
import com.pickeat.backend.global.auth.ParticipantInPickeatArgumentResolverV2;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    private final ParticipantInPickeatArgumentResolverV2 participantInPickeatArgumentResolver;
