...
public interface LoginApiSpec {
    ...
    ResponseEntity<TokenResponse> login(@Parameter(hidden = true) OAuthProviderPrincipal OAuthProviderPrincipal);
    ...
    ResponseEntity<TokenResponse> signup(SignupRequest request,
            @Parameter(hidden = true) OAuthProviderPrincipal OAuthProviderPrincipal);
}
